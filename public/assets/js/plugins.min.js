...
!function (e, t) {
    ...
    var Z = {
        ...
        getDistanceBetweenTouches: function (e) {
            ...
            var t, a, i, s, r, n, o, d, p, u, c, h, v, f, m, g, b = this, w = l(), y = b.zoom, E = b.params.zoom,
...
!function (e) {
    "use strict";
    var s, a, i, t, o, c, r, l, d, n, v, u, b, h, k, p, g, m, f, x, w, y, _, C, z, B, P, M, E, O, D, N, U, V, I, j, A,
        R, X, Y, W, q, $, T, H, Q, S, Z,
    ...
    e.fn.extend({
        venobox: function (ee) {
            ...
            return ae.cb_init(se), this.each(function () {
                ...
                function ie(e) {
                    return !(e.length < 1) && (!m && (m = !0, y = e.data("overlay") || e.data("overlaycolor"), b = e.data("framewidth"), h = e.data("frameheight"), r = e.data("border"), a = e.data("bgcolor"), v = e.data("href") || e.attr("href"), s = e.data("autoplay"), C = e.data("titleattr") && e.attr(e.data("titleattr")) || "", e === P && n.addClass("vbox-animated").addClass("swipe-right"), e === B && n.addClass("vbox-animated").addClass("swipe-left"), D.show(), void n.animate({opacity: 0}, 500, function () {
                ...
                function oe() {
                    ...
                    e("body").off("keydown", te).removeClass("vbox-open"), U.focus(), _.animate({opacity: 0}, 500, function () {
                ...
                se.VBclose = function () {
                    ...
                    }), n.html(""), n.css("opacity", "0"), _.css("opacity", "0"), ee(), _.animate({opacity: 1}, 250, function () {
                ...
                var ne = {DOWN: "touchmousedown", UP: "touchmouseup", MOVE: "touchmousemove"}, ve = function (s) {
                    var a;
                    switch (s.type) {
                        case"mousedown":
                            a = ne.DOWN;
                ...
                function pe(e) {
                    var s, a = function (e) {
                        ...
                        var s = "", a = decodeURIComponent(e).split("?");
                        if (void 0 !== a[1]) {
                            var i, t, o = a[1].split("&");
                ...
                function fe() {
                    c.html(C), n.find(">:first-child").addClass("vbox-figlio").css({
                        ...
                        e.preventDefault()
                    }), d.scrollTop(0), xe(), n.animate({opacity: "1"}, "slow", function () {
                        D.hide()
                    }), ae.cb_content_loaded(U, V, B, P)
                }

                function xe() {
                    var s = n.outerHeight(), a = e(window).height();
...
!function (e) {
    function n(n, t) {
        var o, l, i = this;
        i.btnClass = ".material-scrolltop", i.revealClass = "reveal", i.btnElement = e(i.btnClass), i.initial = {
            revealElement: "body",
            revealPosition: "top",
            padding: 0,
            duration: 600,
            easing: "swing",
            onScrollEnd: null
        }, i.options = e.extend({}, i.initial, t), i.revealElement = e(i.options.revealElement), o = "bottom" !== i.options.revealPosition ? i.revealElement.offset().top : i.revealElement.offset().top + i.revealElement.height(), l = n.offsetTop + i.options.padding, e(document).scroll(function () {
            ...
            var n = !0;
            return e("html, body").animate({scrollTop: l}, i.options.duration, i.options.easing, function () {
                if (n) {
                    n = !1;
...
$(function () {
    var e = $("#contact-form"), t = $(".form-messege");
    $(e).submit(function (r) {
        r.preventDefault();
        var s = $(e).serialize();
        $.ajax({type: "POST", url: $(e).attr("action"), data: s}).done(function (e) {
